<template>
    <div class="content">
        ...
        <div class="login-box">
            ...
            <span></span>
                <router-link to="/reg" active-class='active'>注册</router-link>
            <!-- <a href="reg_m.html"></a> -->
            </div>
            <p class="rsolid"></p>
        </div>
...
<style scoped>
    ...
    .content h1{width:2.18rem;height:2.35rem; background:url(../assets/img/scyh4.png) no-repeat 0 0; background-size:100%; margin:0 auto; margin-top:1.22rem;}
    ...
    .content .login-btn{width:4.65rem;height:0.65rem; background:#ff9200; color:#fff; text-align:center; line-height:0.65rem; border-radius:8px; display:block; margin-top:0.62rem; font-size:0.28rem;}
